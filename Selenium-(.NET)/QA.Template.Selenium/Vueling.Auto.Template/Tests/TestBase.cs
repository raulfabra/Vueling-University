...
namespace Vueling.Auto.Template.Tests
{
    ...
    {
        #region Definitions
        protected LogInPages hacerLogIn;
        
        protected HomePage homePage;
        
        protected HomePage abrirCatalogoLaptops;
        protected HomePage abrirCatalogoPhones;
        protected HomePage abrirCatalogoMonitores;
        
        protected ItemPage añadirLaptopToCart;
        
        protected CartPage abrirCardPage;
        protected CartPage comprobarItems;
        protected CartPage eliminarItems;
